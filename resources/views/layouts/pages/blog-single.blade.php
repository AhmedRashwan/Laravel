                    ...
                    <div class="col-md-12">
                      <article class="aa-blog-single aa-blog-details">
                        <figure class="aa-blog-img">
                          <a href="#"><img alt="img" src="{{asset("img/slider/1.jpg")}}"></a>
                          ...
                          <div class="row">
                            <div class="col-md-6 col-sm-6">
                              <article class="aa-blog-single">
                                <figure class="aa-blog-img">
                                  <a href="#"><img src="{{asset("img/blog-img-1.jpg")}}" alt="img"></a>
                                  <span class="aa-date-tag">15 April, 16</span>
                                </figure>
                                <div class="aa-blog-single-content">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <article class="aa-blog-single">
                                <figure class="aa-blog-img">
                                  <a href="#"><img src="{{asset("img/blog-img-2.jpg")}}" alt="img"></a>
                                  <span class="aa-date-tag">15 April, 16</span>
                                </figure>
                                <div class="aa-blog-single-content">
                                  <h3><a href="#">Lorem ipsum dolor sit amet, consectetur.</a></h3>
                          ...
                          <ul class="commentlist">
                            <li>
                              <div class="media">
                                <div class="media-left">
                                    <img alt="img" src="{{asset("img/testimonial-1.jpg")}}" class="media-object news-img">
                                </div>
                            ...
                            <ul class="children">
                              <li class="author-comments">
                                <div class="media">
                                  <div class="media-left">
                                      <img alt="img" src="{{asset("img/testimonial-3.png")}}" class="media-object news-img">
                                  </div>
                                  <div class="media-body">
                              ...
                              <ul class="children">
                                <li>
                                  <div class="media">
                                    <div class="media-left">
                                        <img alt="img"  src="{{asset("/img/testimonial-1.png")}}" class="media-object news-img">
                                    </div>
                                    <div class="media-body">
                                     <h4 class="author-name">Adam Barney</h4>
                                     <span class="comments-date"> 20th April, 2016</span>
                            ...
                            <li>
                              <div class="media">
                                <div class="media-left">
                                    <img alt="img"  src="{{asset("/img/testimonial-2.png")}}" class="media-object news-img">
                                </div>
                                <div class="media-body">
                ...
                <aside class="aa-blog-sidebar">
                  ...
                  <div class="aa-blog-sidebar-single">
                    ...
                    <div class="aa-blog-recent-post">
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img alt="img" src="{{asset("img/blog-img-3.jpg")}}" class="media-object">
                          </a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img alt="img"  src="{{asset("img/blog-img-2.jpg")}}" class="media-object">
                          </a>
                        </div>
                        <div class="media-body">
                          <h4 class="media-heading"><a href="#">This is Title</a></h4>
                  ...
                  <div class="aa-blog-sidebar-single">
                    <div class="aa-banner-ads">
                      <a href="#">
                        <img src="{{asset("img/banner-ads.jpg")}}" alt="banner img">
                      </a>
                    </div>
                  </div>
                </aside>
